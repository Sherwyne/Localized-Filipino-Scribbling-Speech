...
def main():
    ...
    if args.do_train:
        ...
        with open(args.train_data, 'r', encoding='utf8') as f:
            train_words = [line.strip() for line in f]
        with open(args.evaluation_data, 'r', encoding='utf8') as f:
            test_words = [line.strip() for line in f]
        with open(args.train_tags, 'r', encoding='utf8') as f:
            train_tags = [line.strip() for line in f]
        with open(args.evaluation_tags, 'r', encoding='utf8') as f:
