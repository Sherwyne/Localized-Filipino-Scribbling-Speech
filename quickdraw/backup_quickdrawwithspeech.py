...
def translate_text(text):
    ...
    result = translate_client.translate(text, source_language='tl', target_language='en' )
    ...
    for entity in response.entities:
        ...
        if entity.name in y_offset_keywords:
            ...
            try:
                ...
                print("No drawings found in dataset".format(entity.name))
...
def main():
    ...
    language_code = 'fil-PH'  # a BCP-47 language tag
